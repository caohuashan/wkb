                            ...
                            <tbody>
								...
								<tr class="formtr">
                                    ...
                                    <td class="formtd">
                                     ...
                                     <label><input type="radio" name="info[member_register_checktype]" class="common-radio" <?php if($PW['member_register_checktype']) { ?>checked<?php }?> value="1">短信验证码</label>

                                    &nbsp; &nbsp; &nbsp; &nbsp;

                                     <label><input type="radio" name="info[member_register_checktype]" class="common-radio" <?php if($PW['member_register_checktype']==0) { ?>checked<?php }?> value="0">图片验证码</label>
