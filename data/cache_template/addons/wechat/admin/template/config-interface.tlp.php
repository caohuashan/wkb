...
<head>
	...
	<script src="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>statics/ZeroClipboard/ZeroClipboard.js" language="javascript"></script>
                ...
                <div class="config-items">
                   ...
                   <div class="admin-nav">
                        ...
                        <div class="nav">
                            ...
                            <a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=config">公众号配置</a>

                            <a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=interface" class="hover">公众号接入</a>

                        </div>

                        <div class="admin-tips">

                        	请登录 <a href="https://mp.weixin.qq.com/" target="_blank">微信公众号</a>，进入左侧 最下面 <a href="https://mp.weixin.qq.com/" target="_blank">开发→基本配置</a> 处配置以下参数。
                        ...
                        <table width="100%" class="insert-tab">
                            ...
                            <tbody>
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd"><?php echo format_url(U(MOD));?></td>
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd"><span id="wechat_token"><?php echo isset($PW['wechat_token'])?$PW['wechat_token']:'';?></span></td>
                                ...
                                <tr class="formtr">
                                    ...
                                    <td class="formtd"><span id="wechat_encodingaeskey"><?php echo isset($PW['wechat_encodingaeskey'])?$PW['wechat_encodingaeskey']:'';?></span></td>
								...
								<tr class="formtr">
                                    ...
                                    <td class="formtd">
                                        ...
                                        <input type="button" value="配置好了" onClick="self.location.href='<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=wechat&file=config&action=config'" class="submit-button">
