		...
		$('#iframe-wrap').load(function(){
			...
			if($('#sidebar-list').height()+60>$(window).height())
			{
				$("#sidebar-list ul").each(function(i){
                    var this_memu=$(this).attr('id');

					if(i>0 && this_memu!=now_menu && this_memu!='undefined')
					{
						$(this).hide();
					}
				});
    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
				<li><a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>" style=" padding:0px"><img src="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?>admin/template/images/logo.png" style="height:30px"></a></li>
				...
				<?php if(!$r['disabled'] && (isset($_privileges[$r['folder']]) || $_roleid==-1)) { ?>
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
				...
				<?php }else{ ?>
				<li><a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=&file=admin&action=edit" target="iframe-wrap"><?php echo isset($_username)?$_username:'';?></a></li>
				<?php }?>
                <li><a href="<?php echo defined('PW_PATH')?PW_PATH:'{__PW_PATH__}';?><?php echo defined('ADMIN_FILE')?ADMIN_FILE:'{__ADMIN_FILE__}';?>?mod=&file=admin&action=edit&userid=<?php echo isset($_userid)?$_userid:'';?>" target="iframe-wrap">修改密码</a></li>
